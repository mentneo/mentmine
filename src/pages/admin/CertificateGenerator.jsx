      ...
      {certificateUrl && (
        <div className="mt-4">
          ...
          <div className="flex flex-wrap gap-2 items-center mb-2">
            ...
            <a href={templateUrl} download className="bg-green-600 text-white px-3 py-1 rounded hover:bg-green-700" target="_blank" rel="noopener noreferrer">
              Download Image
            </a>
            <button
              ...
              onClick={async () => {
                if (navigator.share) {
                  await navigator.share({
                    ...
                    text: 'Check out my certificate image!',
                    url: templateUrl
                  });
                } else {
